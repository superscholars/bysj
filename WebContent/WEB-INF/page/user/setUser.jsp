...
<body>
	...
	<div class="row">
		...
		<div class="form">
			<h2>修改头像</h2>
			<form name="settingHead" action="${ctx}/user/user_settingHead.action" enctype="multipart/form-data"
			...
			<h2>修改密码</h2>
			<form class="form" name="settingPassword" action="${ctx}/user/user_settingPassword.action" method="post" role="form">
				<div class="row">
					<div class="form-group col-md-5">

...
<body>
	...
	<div>
		...
		<form name="editStrategy" action="${ctx}/merchant/strategy_doAdd.action"
			...
			<div class="row">
				<div class="form-group col-xs-6 col-md-6">
					...
					<select class="form-control" id="strategyType" name="strategyType">
			            <option value="1" <c:if test="${strategy.strategyType == 1}">selected</c:if>>新用户优惠</option>
			            <option value="2" <c:if test="${strategy.strategyType == 2}">selected</c:if>>满减优惠</option>
			            <option value="3" <c:if test="${strategy.strategyType == 3}">selected</c:if>>折扣优惠</option>
			        </select>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-xs-6 col-md-6">
					<label class="control-label " for="premisePrice">优惠前提(如果新用户优惠，此选项无效)</label> 
			...
			<div class="row">
				<div class="form-group col-xs-6 col-md-6">
					 <label class="control-label " for="discount">折扣(如果满减优惠，此选项无效;如果新用户优惠，此选项无效)</label>
